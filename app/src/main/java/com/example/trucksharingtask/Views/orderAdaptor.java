package com.example.trucksharingtask.Views;
...
public class orderAdaptor extends RecyclerView.Adapter<orderAdaptor.OrderViewHolder>{
    ...
    public void onBindViewHolder(@NonNull orderAdaptor.OrderViewHolder holder, int position) {
        ...
        // Assuming you have a method getImageUrl() in your orderModel class to get the image URL or URI.
        String imageUrl = "android.resource://com.example.trucksharingtask/drawable/user";

        // Log the URL for debugging
        Log.d("orderAdapter", "Image URL: " + imageUrl);
